...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'csamanicg';//this will be your WCC username
      $dbUsr = 'csamanicg';//this will be your WCC username
      $dbPass = '9VgaB3ayK2D4';//this will be the password found in the video.
